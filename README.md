...
### **Database**
- **MySQL** – Relational database for storing train, station, and user data
RailEase/
│
├── frontend/ # React.js + Tailwind CSS code (Web)
├── mobile-app/ # React Native mobile app code
├── backend/ # Node.js server code
├── database/ # SQL scripts & schema
└── README.md # Project documentationgit init